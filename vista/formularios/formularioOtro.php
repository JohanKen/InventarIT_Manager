...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['guardar'])) {
        ...
        Toast.fire({
            icon: 'success',
            title: 'Dipsositivo actualizado correctamente'
        });
        setTimeout(function(){
        ...
        <div class="row fle">
            <div class="col-md-6 headd">
                <h1
                    ...
                    ACTUALIZAR DISPOSITIVO</h1>
            </div>
        <div class="col-md-6 heaad">
            <img src="images/dis/otros.png" alt="imagenLaptop" style="width:170px;" class="img-fluid">            
        </div>
        </div>
    </div>
    ...
    <div class="container mt-52">
        ...
        ?>
            ...
            <div class="col-3">
                        ...
                        ?>
                            ...
                            <div class="mb-3" id="">
                                    ...
                                    <input type="text" class="form-control" name="precio" id="precioInput"
                                        ...
                                        oninput="formatoPrecio(this)" required>
                                </div>
                            </div>
                ...
                <div class="col-3">
                <div class="mb-3" id="">
                    <label for="nota" class="form-label">Descripción del dispositivo</label>

...
<body>
    ...
    <div class="container-fluid">
            <div class="row fle">
                ...
                <h1 style="font-size: 28px; font-weight: bold; color: #003363; text-transform: uppercase; border-bottom: 2px solid #003363; ">NUEVO MOUSE</h1>
                </div>

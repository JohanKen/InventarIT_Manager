    ...
    <div class="contentSeccion">
        ...
        <form action="" method="post" encytype="multipart/form-data">
            ...
            <div class="mb-3" id="formForm">
                ...
                <input type="tect" class="form-control" name="precio" id="precioInput">
            </div>

            <div class="mb-3" id="formForm">
                <label for="fecha_compra" class="form-label">Fecha de compra</label>
                <input type="date" class="form-control" name="fecha_compra" id="fechaCompraInput" placeholder="Selecciona una fecha">
            </div>

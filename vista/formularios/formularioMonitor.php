...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['guardar'])) {
        ...
        Toast.fire({
            icon: 'success',
            title: 'Monitor actualizado correctamente'
        });
        setTimeout(function(){
...
<head>
    ...
    <title>Actualizar Monitor</title>
        ...
        <div class="row fle">
            <div class="col-md-6 headd">
                <h1
                    ...
                    Actualizar monitor</h1>
            </div>
            <div class="col-md-6 heaad">
            <img src="images/dis/monitor.png" alt="imagenLaptop" style="width:170px;" class="img-fluid">            
        </div>
        </div>
    </div>

...
<body>
    ...
    <div class="container-fluid">
            <div class="row fle">
                ...
                <h1 style="font-size: 28px; font-weight: bold; color: #003363; text-transform: uppercase; border-bottom: 2px solid #003363; ">Otro</h1>
                </div>
                <div class="col-md-6 heaad">
                    <img src="images/dis/otros.png" alt="imagenLaptop" style="width:240px;" class="img-fluid">
                </div>
            </div>
        </div>

...
<body>
    <div class="contentSeccion">
        ...
        <div class="up">
            <header clas="headerTabla">
                <h1>Nuevo Dispositivo Sin Categoria</h1>
            </header>
        </div>

...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 768px) {
            #IMGlaptop{
                max-width: 150px; /* Reducir el tamaño de la imagen en tabletas */
            max-height: 150px;
            }
        }
    </style>
    ...
    <div class="contentSeccion">  
        <div class="up">
            <header class="headerTabla">
                ...
                <div class="col-md-12 text-center">
    <div class="input-group input-group-sm mt-3" style="max-width: 300px; margin: auto;">
        ...
        <button class="btn btn-outline-success" type="submit">Buscar</button>
            ...
            <div class="col-md-12 text-center" >
            <button class="btn btn-primary" onclick="nuevoDispositivo();">AGREGAR NUEVO DISPOSITIVO</button>

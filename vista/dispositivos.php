...
// Verifica si existe la sesión y si el usuario está autenticado
if (isset($_SESSION['usuario'])) {
    // Si el usuario está autenticado, muestra la página de dispositivos
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="contentSeccion">
        ...
        <div class="tabla">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    // Llamada a método para eliminar dispositivos
                    $eliminar = new ControladorDispositivos;
                    $eliminar->borrarDispositivos();

                    // Llamada a método para mostrar todos los dispositivos
